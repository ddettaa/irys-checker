              ...
              <CardItem translateZ="10" className="w-full pt-2">
                <div className="flex items-center justify-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center w-5 h-5 text-emerald-500 hover:text-neutral-700 dark:hover:text-neutral-300 transition-colors"
